...
//         args[i].length() - DirectDeflater.DEFLATE_SUFFIX.length()));
        ...
        FileInputStream fin = new FileInputStream("I:/workspace/network/net3programe/src/javaio/jio/ch10/DirectInflater.zip");  
        FileOutputStream fout = new FileOutputStream("I:/workspace/network/net3programe/src/javaio/jio/ch10/DirectInflater.txt");
