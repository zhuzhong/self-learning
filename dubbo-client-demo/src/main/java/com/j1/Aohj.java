...
public class Aohj {
    ...
    public static void writeRrandomFile() {
        ...
        try (BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(RANDOMFILE),
                CHARSETNAME))) {
            for (int i = 0; i < N; i++) {
    ...
    public static void readRrandomFile() {
        long beginTime = System.currentTimeMillis();
        try (BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(RANDOMFILE), CHARSETNAME));) {
            String line;
            int index = 0;
    ...
    public static void writeSortFile() {
        long beginTime = System.currentTimeMillis();
        try (BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(SORTFILE), CHARSETNAME))) {
            for (int i = 0; i < N; i++) {
