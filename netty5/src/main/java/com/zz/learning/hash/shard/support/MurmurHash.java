...
import com.zz.learning.hash.shard.Hashing;
import com.zz.learning.hash.shard.SafeEncoder;

/**
 * This is a very fast, non-cryptographic hash suitable for general hash-based
 * lookup. See http://murmurhash.googlepages.com/ for more details. <br>
 * <p>
...
public class MurmurHash implements Hashing {
    ...
    private static long hash64A(ByteBuffer buf, int seed) {
        ByteOrder byteOrder = buf.order();
        buf.order(ByteOrder.LITTLE_ENDIAN); // 小端模式
