...
public class AddressUtils {
	...
	public static void main(String[] args) {
		...
		String address = "";
		try {
			IPAddress a = getAddress(ip, "utf-8");
			address = a == null ? null : a.toString();
		} catch (Exception e) {
			e.printStackTrace();
		}
	 ...
	 * @throws Exception
	 */
	public static IPAddress getAddress(String ip, String encoding)
			throws Exception {
		...
		if (returnStr != null) {
			IPAddress ipaddress = JSON.parseObject(returnStr, IPAddress.class);
			return ipaddress;
		}
